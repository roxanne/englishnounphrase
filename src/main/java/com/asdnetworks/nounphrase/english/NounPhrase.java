...
// Methods for nodes in cardinal.grm subgrammar:
   ...
   static final String GRAMMARFILENAME =
           "http://www.asdnetworks.com/grammars/nounphrasesimple.grm";
...
   private class NounPhraseWindow extends JFrame
   {  NounPhraseWindow(NounPhrase givenDriver)
    ...
    JButton newGrammarFileButton = new JButton(new ImageIcon(getClass().
     getClassLoader().getResource("open.gif")));
    ...
    JButton completeParseButton = new JButton(new ImageIcon(getClass().
      getClassLoader().getResource("parse.png")));
    ...
    JButton  semanticValueButton = new JButton(new ImageIcon(getClass().
      getClassLoader().getResource("step.png")));
     ...
     semanticValueButton.addActionListener(new ActionListener() {
      ...
      JButton  showPhraseButton = new JButton(new ImageIcon(getClass().
        getClassLoader().getResource("report_word.png")));
    ...
    getClassLoader().getResource("sideparse.png")));
    ...
    JButton selectButton = new JButton(new ImageIcon(getClass().
     getClassLoader().getResource("copy.gif")));
    ...
    JButton  cutEraseButton = new JButton(new ImageIcon(getClass().
     getClassLoader().getResource("cut.gif")));
    ...
    JButton exitButton = new JButton(new ImageIcon(getClass().
     getClassLoader().getResource("delete.gif")));
 ...
 /*
     static {
         try {
             ...
             System.err.println(
                     "main/java/com/asdnetworks/nounphrase/resources/nounphrase.properties not found");
             System.exit(1);
         }
     }
    */
    static {
       try {
           resources = ResourceBundle.getBundle("Nounphrase",
                   Locale.getDefault());
            //String propertyValue = resources.getString("key")
       } catch (MissingResourceException mre) {
            System.err.println("resources/Nounphrase.properties not found");
            System.exit(1);
       }
   }
