...
class Notepad extends JPanel {
    ...
    /*static {
        try {
            resources = ResourceBundle.getBundle("com.asdnetworks.nounphrase.resources.Notepad",
                    Locale.getDefault());
    ...
    */
    ...
    static {
        try {
            ...
            properties.load(com.asdnetworks.nounphrase.english.Notepad.class.getResourceAsStream(
                    "com/asdnetworks/nounphrase/resources/Notepad.properties"));
            resources = ResourceBundle.getBundle("com.asdnetworks.nounphrase.resources.Notepad",
                    Locale.getDefault());
        } catch (MissingResourceException | IOException  e) {
            System.err.println("com/asdnetworks/nounphrase/resources/Notepad.properties "
                    + "or com/asdnetworks/nounphrase/resources/Notepad.properties not found");
            System.exit(1);
        }
    }
